...
class Database(abc.ABC):
    ...
    async def select_join(
        ...
        *table_models: type[sqlmodel.SQLModel],
        ...
        Returns:
            ScalarResult[typing.Any] | None: A `ScalarResult` which contains a scalar
                value or sequence of scalar values.
        """
    ...
    async def select_all_join(
        ...
        *table_models: type[sqlmodel.SQLModel] | sqlmodel.SQLModel,
        ...
        Returns:
            ChunkedIteratorResult | None: A `ChunkedIteratorResult` which contains a
                sequence of scalar values.
        """
